...
namespace VeryAnimation
{
    ...
    public class VeryAnimationWindow : EditorWindow
    {
        ...
        public static readonly string version = "1.1.9p2";
        ...
        private void OnGUI()
        {
            ...
            else if (!va.edit)
            {
                ...
                errorLogScrollPosition = EditorGUILayout.BeginScrollView(errorLogScrollPosition);
                {
                    #region UnityVersion
                    {
#if UNITY_2019_2_OR_NEWER || !UNITY_5_6_OR_NEWER
...
#if UNITY_EDITOR_OSX
                                EditorGUILayout.LabelField("N", "[Hierarchy] Hide select bones");
                                EditorGUILayout.LabelField("Shift + N", "[Hierarchy] Show select bones");
